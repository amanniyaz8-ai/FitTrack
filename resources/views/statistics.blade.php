...
function setExpenseType(type) {
    ...
    document.getElementById('field-rent').classList.toggle('hidden', type !== 'rent');
    document.getElementById('field-percent').classList.toggle('hidden', type !== 'percent');
    ['rent','percent'].forEach(t => {
        const tab = document.getElementById('tab-'+t);
        if (t === type) {
            tab.classList.add('border-orange-500','text-orange-500','bg-orange-50');
            tab.classList.remove('border-gray-200','text-gray-500');
        } else {
            tab.classList.remove('border-orange-500','text-orange-500','bg-orange-50');
