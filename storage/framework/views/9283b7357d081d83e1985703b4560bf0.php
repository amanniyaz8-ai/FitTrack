...
<head>
    ...
    <title><?php echo e(config('app.name', 'FitTrack')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
        ...
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center space-x-8">
                ...
                <div class="hidden md:flex space-x-4">
                    <a href="<?php echo e(route('dashboard')); ?>"
                        class="px-3 py-2 rounded-md text-sm font-medium transition <?php echo e(request()->routeIs('dashboard') ? 'text-white bg-blue-900' : 'text-gray-300 hover:text-white'); ?>">
                        <i class="fas fa-tachometer-alt mr-1"></i> <?php echo e(__('app.nav_monitor')); ?>

                    </a>
                    <a href="<?php echo e(route('clients.index')); ?>"
                        class="px-3 py-2 rounded-md text-sm font-medium transition <?php echo e(request()->routeIs('clients.*') ? 'text-white bg-blue-900' : 'text-gray-300 hover:text-white'); ?>">
                        <i class="fas fa-users mr-1"></i> <?php echo e(__('app.nav_clients')); ?>

                    </a>
                    <a href="<?php echo e(route('statistics')); ?>"
                        class="px-3 py-2 rounded-md text-sm font-medium transition <?php echo e(request()->routeIs('statistics') ? 'text-white bg-blue-900' : 'text-gray-300 hover:text-white'); ?>">
                        <i class="fas fa-chart-bar mr-1"></i> <?php echo e(__('app.nav_statistics')); ?>
            ...
            <div class="flex items-center gap-1 sm:gap-3">
                ...
                <div class="flex items-center gap-0.5 text-xs font-semibold" style="position:relative;z-index:100;">
                    <button type="button" onclick="window.location.href='<?php echo e(route('lang.switch', 'ru')); ?>'"
                       class="px-2 py-1.5 rounded-md cursor-pointer border-0"
                       style="<?php echo e(app()->getLocale() === 'ru' ? 'background-color:#f97316;color:white;' : 'background:transparent;color:#9ca3af;'); ?>">
                        RU
                    </button>
                    <button type="button" onclick="window.location.href='<?php echo e(route('lang.switch', 'kk')); ?>'"
                       class="px-2 py-1.5 rounded-md cursor-pointer border-0"
                       style="<?php echo e(app()->getLocale() === 'kk' ? 'background-color:#f97316;color:white;' : 'background:transparent;color:#9ca3af;'); ?>">
                        KZ
                    </button>
                </div>
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" class="text-gray-300 text-sm hidden md:flex items-center gap-1.5 hover:text-white transition">
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                    ...
                    <button type="submit" class="text-gray-300 hover:text-white text-sm px-2 py-2 rounded-md hover:bg-blue-900 transition flex items-center gap-1">
                        ...
                        <span class="hidden md:inline"><?php echo e(__('app.nav_logout')); ?></span>
                    </button>
                </form>
            </div>
        </div>
...
<div id="mobile-nav" class="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-blue-900 safe-area-bottom" style="background-color: #0a1628;">
    <div class="flex">
        <a href="<?php echo e(route('dashboard')); ?>" class="flex-1 text-center py-3 text-sm <?php echo e(request()->routeIs('dashboard') ? 'text-orange-400' : 'text-gray-300'); ?>" style="<?php echo e(request()->routeIs('dashboard') ? 'color: #fb923c;' : ''); ?>">
            <i class="fas fa-tachometer-alt block text-lg"></i>
            <?php echo e(__('app.nav_monitor')); ?>

        </a>
        <a href="<?php echo e(route('clients.index')); ?>" class="flex-1 text-center py-3 text-sm <?php echo e(request()->routeIs('clients.*') ? 'text-orange-400' : 'text-gray-300'); ?>" style="<?php echo e(request()->routeIs('clients.*') ? 'color: #fb923c;' : ''); ?>">
            <i class="fas fa-users block text-lg"></i>
            <?php echo e(__('app.nav_clients')); ?>

        </a>
        <a href="<?php echo e(route('statistics')); ?>" class="flex-1 text-center py-3 text-sm <?php echo e(request()->routeIs('statistics') ? 'text-orange-400' : 'text-gray-300'); ?>" style="<?php echo e(request()->routeIs('statistics') ? 'color: #fb923c;' : ''); ?>">
            <i class="fas fa-chart-bar block text-lg"></i>
            <?php echo e(__('app.nav_statistics')); ?>

        </a>
        <a href="<?php echo e(route('profile.edit')); ?>" class="flex-1 text-center py-3 text-sm <?php echo e(request()->routeIs('profile.*') ? 'text-orange-400' : 'text-gray-300'); ?>" style="<?php echo e(request()->routeIs('profile.*') ? 'color: #fb923c;' : ''); ?>">
            <i class="fas fa-user-circle block text-lg"></i>
            <?php echo e(__('app.nav_profile')); ?>
...
<?php /**PATH /Users/amanniyaz8gmail.com/Desktop/Код/fittrack/resources/views/layouts/app.blade.php ENDPATH**/ ?>