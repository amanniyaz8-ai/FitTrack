    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <?php if($errors->any()): ?>
                <div class="bg-red-50 border border-red-200 rounded-lg px-4 py-3 mb-5 text-red-600 text-sm">
                    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p><i class="fas fa-exclamation-circle mr-1"></i><?php echo e($e); ?></p>
            ...
            <form method="POST" action="<?php echo e(route('password.email')); ?>">
                ...
                <div class="mb-5">
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                        class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 text-sm <?php echo e($errors->has('email') ? 'border-red-400' : ''); ?>"
            ...
            <p class="mt-5 text-center text-sm text-gray-500">
                Вспомнили пароль?
                <a href="<?php echo e(route('login')); ?>" class="font-medium hover:underline" style="color: #f97316;">Войти</a>
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/amanniyaz8gmail.com/Desktop/Код/fittrack/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>