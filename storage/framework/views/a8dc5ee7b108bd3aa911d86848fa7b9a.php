<?php $__env->startSection('title', 'Редактирование клиента'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center mb-6 gap-3">
        ...
        <h1 class="text-2xl font-bold" style="color: #0f2035;">Редактирование: <?php echo e($client->full_name); ?></h1>
    </div>
    ...
    <div class="mt-6 bg-red-50 border border-red-200 rounded-xl p-4">
        ...
        <form method="POST" action="<?php echo e(route('clients.destroy', $client)); ?>" onsubmit="return confirm('Удалить клиента <?php echo e(addslashes($client->full_name)); ?>?')">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/amanniyaz8gmail.com/Desktop/Код/fittrack/resources/views/clients/edit.blade.php ENDPATH**/ ?>