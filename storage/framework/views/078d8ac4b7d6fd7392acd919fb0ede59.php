...
<div class="space-y-4">
    <div>
        ...
        <input type="text" name="full_name" value="<?php echo e(old('full_name', $client->full_name ?? '')); ?>"
            class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 <?php echo e($errors->has('full_name') ? 'border-red-400' : 'border-gray-300'); ?>"
    ...
    <div>
        ...
        <textarea name="goal" rows="3"
            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2"
            placeholder="Например: похудеть на 10 кг, набрать мышечную массу..."><?php echo e(old('goal', $client->goal ?? '')); ?></textarea>
    </div>
    ...
    <div>
        ...
        <textarea name="contraindications" rows="2"
            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2"
            placeholder="Укажите если есть противопоказания..."><?php echo e(old('contraindications', $client->contraindications ?? '')); ?></textarea>
    </div>
...
<div class="mt-6 border-t border-gray-200 pt-6">
    <div class="flex items-center gap-3 mb-4">
        <input type="checkbox" name="create_package" id="create_package" value="1"
            <?php echo e(old('create_package') ? 'checked' : ''); ?>
    ...
    <div id="package-fields" class="<?php echo e(old('create_package') ? '' : 'hidden'); ?> space-y-4 bg-orange-50 border border-orange-200 rounded-xl p-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Количество тренировок</label>
                <input type="number" name="pkg_total_sessions" value="<?php echo e(old('pkg_total_sessions', 10)); ?>" min="1" max="100"
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" name="pkg_price" value="<?php echo e(old('pkg_price', 60000)); ?>" min="0"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="date" name="pkg_payment_date" value="<?php echo e(old('pkg_payment_date', date('Y-m-d'))); ?>"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-400 bg-white">
            </div>
            <div class="flex items-end pb-2">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="pkg_is_paid" value="1" <?php echo e(old('pkg_is_paid') ? 'checked' : ''); ?>
...
<?php /**PATH /Users/amanniyaz8gmail.com/Desktop/Код/fittrack/resources/views/clients/_form.blade.php ENDPATH**/ ?>